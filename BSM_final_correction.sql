...
create table if not exists Loan(
      L_ID varchar(10) unique not null,
...
create table if not exists Account(
      A_AccountNo varchar(10) unique not null,
...
create table if not exists Branch(
      B_ID varchar(10) unique not null,
      B_Name varchar(25)  not null default '',
      B_Address varchar(50)  not null,
      primary key(B_ID),
      L_ID varchar(10), 
      foreign key(L_ID) 
      references Loan(L_ID),
      A_AccountNo varchar(10), 
...
insert into Branch values ('5005','Karol Bagh Branch','11/335,Bank Street, Karol Bagh, New Delhi',2005,3005);
